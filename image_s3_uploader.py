        ...
        for song_data in songs_data.get('songs', []):
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    upload_image_to_s3_bucket(S3_BUCKET_NAME, S3_BUCKET_REGION,
                                              response.content, image_name,
                                              song)
...
if __name__ == "__main__":
    try:
        ...
        print(f"INFO: Creating/verifying S3 bucket '{S3_BUCKET_NAME}' in {S3_BUCKET_REGION}")
        create_private_s3_bucket(S3_BUCKET_NAME, S3_BUCKET_REGION)
